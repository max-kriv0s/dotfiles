...
nvm use 22               # переключиться на версию 22
nvm alias default 22     # сделать версию дефолтной
nvm ls                   # список установленных версий
nvm current              # текущая версия
```
> В папке проекта можно создать `.nvmrc` с нужной версией — nvm подхватит автоматически.
